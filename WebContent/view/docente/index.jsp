    ...
    <div class="container mt-4">
        ...
        <% if(request.getAttribute("classeCorrente") != null) { %>
            ...
            <div class="alert alert-info">
                ...
                Stai visualizzando i docenti della classe:
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <% if (loggedUser != null && loggedUser.isAdmin()) { %>
                ...
                <a
                    href="<%= request.getContextPath() %>/Docente?action=INSERT"
        ...
        <%
            List<Docente> docenti =
                    (List<Docente>) request.getAttribute("docenti");
        %>
                            ...
                            <tr>
                                ...
                                <% if (loggedUser != null && loggedUser.isAdmin()) { %>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a
                                            href="<%= request.getContextPath() %>/Docente?action=EDIT&id=<%= d.getId() %>"
                                        ...
                                        <a
                                            href="<%= request.getContextPath() %>/Docente?action=DELETE&id=<%= d.getId() %>"
