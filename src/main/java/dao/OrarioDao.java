...
public class OrarioDao extends AbstractDAO {
	...
	public List<Orario> getByClasse(int classeId) throws Exception {
		...
		String sql = "SELECT " + "o.*, " + "c.nome AS classe_nome, " + "d.cognome AS docente_cognome "
				+ "FROM orario o " + "JOIN classi c ON o.classe_id = c.id " + "JOIN docenti d ON o.docente_id = d.id "
				+ "WHERE o.classe_id = ? " + "ORDER BY FIELD(o.giorno,"
				+ "'Lunedi','Martedi','Mercoledi','Giovedi','Venerdi')," + "o.ora";
	...
	public List<Orario> getByDocente(int docenteId) throws Exception {

		List<Orario> list = new ArrayList<>();

		String sql = "SELECT " + "o.*, " + "c.nome AS classe_nome, " + "d.cognome AS docente_cognome "
				+ "FROM orario o " + "JOIN classi c ON o.classe_id = c.id " + "JOIN docenti d ON o.docente_id = d.id "
				+ "WHERE o.docente_id = ? " + "ORDER BY FIELD(o.giorno,"
				+ "'Lunedi','Martedi','Mercoledi','Giovedi','Venerdi')," + "o.ora";
