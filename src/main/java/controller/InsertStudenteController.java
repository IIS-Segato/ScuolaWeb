...
/**
 * Servlet implementation class InsertStudenteController
 */
@WebServlet("/InsertStudenteController")
public class InsertStudenteController extends HttpServlet {
     ...
     */
    public InsertStudenteController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        s.setPassword(stringBuilder.toString());
        
        try {
			amministratoreDAO.insertStudente(s);
